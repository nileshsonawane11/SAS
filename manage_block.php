<div class="animate-fadeIn">
    ...
    <div class="table-wrapper">
        <table class="staff-table">
            <thead>
                <tr>
                    <th><input type="checkbox" onclick="toggleAllblks(this)"></th>
                    <th>Sr. No</th>
                    <th>Block No.</th>
                    <th>Single Sit</th>
                    <th>Department</th>
            ...
            <tbody>
                ...
                <?php 
                    ...
                    echo '<tr><td colspan="6" style="text-align: center; padding: 40px; color: #64748b;">No blocks found. Add your first block!</td></tr>';
                }
