...
<div class="table-wrapper">
    <table class="staff-table">
        <thead>
            <tr>
                <th>
                    <input type="checkbox" onclick="toggleAllblks(this)">
                </th>
                <th>Sr. No</th>
                <th>Block No.</th>
                <th>Single Sit</th>
        ...
        <tbody>
            ...
            <tr data-id="<?php echo $row['id']; ?>">
                <td>
                    <input type="checkbox" class="row-check-blk" value="<?php echo $row['id']; ?>" onclick="toggleDeleteblkBtn()">
                </td>
                <td><?php echo $count; ?></td>
                <td id="blk-no"><?php echo $row['block_no']; ?></td>
