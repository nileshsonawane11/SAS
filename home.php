...
<head>
    ...
    <title>Dashboard - <?= $user_data['i_name']; ?> Admin</title>
    <style>
        :root {
            --primary: #7c3aed;
            --primary-dark: #6d28d9;
    ...
    <div class="menu" id="sidebar">
        <div class="admin-details">
            ...
            <div class="logo-name">
                ...
                <label for="" class="admin-name"><?= $user_data['i_name']; ?></label>
            </div>
        </div>
        <div class="menu-items">
            ...
            <div class="items" data-page="manage_committee.php">
                <svg width="24" height="24" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.5 10.3125C24.2405 10.3125 25.9097 11.0039 27.1404 12.2346C28.3711 13.4653 29.0625 15.1345 29.0625 16.875C29.0625 18.6155 28.3711 20.2847 27.1404 21.5154C25.9097 22.7461 24.2405 23.4375 22.5 23.4375C20.7595 23.4375 19.0903 22.7461 17.8596 21.5154C16.6289 20.2847 15.9375 18.6155 15.9375 16.875C15.9375 15.1345 16.6289 13.4653 17.8596 12.2346C19.0903 11.0039 20.7595 10.3125 22.5 10.3125ZM9.375 15C10.425 15 11.4 15.2812 12.2438 15.7875C11.9625 18.4687 12.75 21.1312 14.3625 23.2125C13.425 25.0125 11.55 26.25 9.375 26.25C7.88316 26.25 6.45242 25.6574 5.39752 24.6025C4.34263 23.5476 3.75 22.1168 3.75 20.625C3.75 19.1332 4.34263 17.7024 5.39752 16.6475C6.45242 15.5926 7.88316 15 9.375 15ZM35.625 15C37.1168 15 38.5476 15.5926 39.6025 16.6475C40.6574 17.7024 41.25 19.1332 41.25 20.625C41.25 22.1168 40.6574 23.5476 39.6025 24.6025C38.5476 25.6574 37.1168 26.25 35.625 26.25C33.45 26.25 31.575 25.0125 30.6375 23.2125C32.2716 21.1017 33.0303 18.4428 32.7562 15.7875C33.6 15.2812 34.575 15 35.625 15ZM10.3125 34.2187C10.3125 30.3375 15.7688 27.1875 22.5 27.1875C29.2312 27.1875 34.6875 30.3375 34.6875 34.2187V37.5H10.3125V34.2187ZM0 37.5V34.6875C0 32.0812 3.54375 29.8875 8.34375 29.25C7.2375 30.525 6.5625 32.2875 6.5625 34.2187V37.5H0ZM45 37.5H38.4375V34.2187C38.4375 32.2875 37.7625 30.525 36.6562 29.25C41.4562 29.8875 45 32.0812 45 34.6875V37.5Z" fill="currentColor"/>
                </svg>
                <span>Manage Committee</span>
            </div>
            <div class="items" data-page="manage_peon.php">
                <svg width="24" height="24" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.5 10.3125C24.2405 10.3125 25.9097 11.0039 27.1404 12.2346C28.3711 13.4653 29.0625 15.1345 29.0625 16.875C29.0625 18.6155 28.3711 20.2847 27.1404 21.5154C25.9097 22.7461 24.2405 23.4375 22.5 23.4375C20.7595 23.4375 19.0903 22.7461 17.8596 21.5154C16.6289 20.2847 15.9375 18.6155 15.9375 16.875C15.9375 15.1345 16.6289 13.4653 17.8596 12.2346C19.0903 11.0039 20.7595 10.3125 22.5 10.3125ZM9.375 15C10.425 15 11.4 15.2812 12.2438 15.7875C11.9625 18.4687 12.75 21.1312 14.3625 23.2125C13.425 25.0125 11.55 26.25 9.375 26.25C7.88316 26.25 6.45242 25.6574 5.39752 24.6025C4.34263 23.5476 3.75 22.1168 3.75 20.625C3.75 19.1332 4.34263 17.7024 5.39752 16.6475C6.45242 15.5926 7.88316 15 9.375 15ZM35.625 15C37.1168 15 38.5476 15.5926 39.6025 16.6475C40.6574 17.7024 41.25 19.1332 41.25 20.625C41.25 22.1168 40.6574 23.5476 39.6025 24.6025C38.5476 25.6574 37.1168 26.25 35.625 26.25C33.45 26.25 31.575 25.0125 30.6375 23.2125C32.2716 21.1017 33.0303 18.4428 32.7562 15.7875C33.6 15.2812 34.575 15 35.625 15ZM10.3125 34.2187C10.3125 30.3375 15.7688 27.1875 22.5 27.1875C29.2312 27.1875 34.6875 30.3375 34.6875 34.2187V37.5H10.3125V34.2187ZM0 37.5V34.6875C0 32.0812 3.54375 29.8875 8.34375 29.25C7.2375 30.525 6.5625 32.2875 6.5625 34.2187V37.5H0ZM45 37.5H38.4375V34.2187C38.4375 32.2875 37.7625 30.525 36.6562 29.25C41.4562 29.8875 45 32.0812 45 34.6875V37.5Z" fill="currentColor"/>
                </svg>
                <span>Manage Peons</span>
            </div>
...
<script>
    function saveSettings() {
        const data = {
            ...
            duty_rate: parseInt(document.querySelectorAll('input[type=number]')[1].value),
            reliever: parseInt(document.querySelectorAll('input[type=number]')[2].value),
            extra_faculty: document.querySelectorAll('input[type=number]')[3].value / 100,
...
<script>
    function addCommittee(e) {
        ...
        let form = new FormData(document.getElementById("committeeForm"));

        fetch("committee_controller.php?action=add", {
            method: "POST",
            body: form
        })
        .then(res => res.text())
    ...
    function deleteCommittee(id) {
        ...
        fetch("committee_controller.php?action=delete&id=" + id)
            .then(res => res.text())
            .then(data => {
    ...
    function searchCommittee() {
        ...
        fetch("committee_controller.php?action=search&query=" + val)
        .then(res => res.text())
        .then(html => {
            document.getElementById("committeeBody").innerHTML = html;
        });
    }
    ...
    // UPDATE
    function updateCommittee(e) {
        e.preventDefault();
        let form = new FormData(document.getElementById("editForm"));

        fetch("committee_controller.php?action=update", {
            method: "POST",
            body: form
        })
        .then(res => res.text())
...
<script>
    function addPeon(e) {
        ...
        let form = new FormData(document.getElementById("peonForm"));

        fetch("peon_controller.php?action=add", {
            method: "POST",
            body: form
        })
        .then(res => res.text())
        .then(data => {
            loadPage('manage_peon.php');
        });
    }

    function deletePeon(id) {
        if (!confirm("Delete this member?")) return;

        fetch("peon_controller.php?action=delete&id=" + id)
            .then(res => res.text())
            .then(data => {
                document.getElementById("row" + id).remove();
            });
    ...
    function searchPeon() {
        ...
        fetch("peon_controller.php?action=search&query=" + val)
        .then(res => res.text())
        .then(html => {
            document.getElementById("peonBody").innerHTML = html;
        });
    }
    ...
    function close_peon_Edit() {
        document.getElementById("edit_peon_Modal").style.display = "none";
    }

    // UPDATE
    function updatePeon(e) {
        e.preventDefault();
        let form = new FormData(document.getElementById("edit_peon_Form"));

        fetch("peon_controller.php?action=update", {
            method: "POST",
            body: form
        })
        .then(res => res.text())
