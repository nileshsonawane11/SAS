...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-file-pdf"></i> PDF Export Panel</h1>
            <p>Generate comprehensive supervision reports and documents with a single click</p>
        </div>
            ...
            <form method="get">
                ...
                <div class="actions-grid">
                    ...
                    <button type="submit" name="action" value="overall" class="action-button">
                        ...
                        <div class="button-desc">Generate a complete supervision report including all departments, roles, and faculty members.</div>
                        <div class="button-footer">
                            <span class="button-type">Full Report</span>
                    ...
                    <button type="submit" name="action" value="department" class="action-button">
                        ...
                        <div class="button-desc">Create separate PDF reports for each department with detailed supervision data.</div>
                        <div class="button-footer">
                            <span class="button-type">By Department</span>
                            <i class="fas fa-arrow-right button-arrow"></i>
                        </div>
                    </button>
                    ...
                    <button type="submit" name="action" value="role" class="action-button">
                        ...
                        <div class="button-desc">Generate reports categorized by teaching and non-teaching staff roles.</div>
                        <div class="button-footer">
                            <span class="button-type">By Role</span>
                            <i class="fas fa-arrow-right button-arrow"></i>
                        </div>
                    </button>
                    ...
                    <button type="submit" name="action" value="individual" class="action-button">
                        ...
                        <div class="button-desc">Create personalized appointment letters for each faculty member.</div>
                        <div class="button-footer">
                    ...
                    <button type="submit" name="action" value="faculty_signature" class="action-button">
                        ...
                        <div class="button-desc">Generate a comprehensive faculty list with designated signature columns.</div>
                        <div class="button-footer">
                            <span class="button-type">Official List</span>
                            <i class="fas fa-arrow-right button-arrow"></i>
                        </div>
                    </button>
