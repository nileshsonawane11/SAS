...
$staff_result = mysqli_query($conn,"SELECT * FROM peons WHERE id = $id AND Created_by = '$owner'");
$courses = [];
    ...
    <div class="container">
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <span style="color: black;">Peon Profile </span>
                </div>
            </div>
        </div>
        ...
        <div class="content-grid">
            ...
            <div class="card" id="personal-card">
                ...
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-user"></i> Peon Name <sup class="danger">*</sup>
                    </div>
                    <div id="f_name" class="field-value editable" data-field="staffName"><?= $staff_data['name'] ?? '' ?></div>
                </div>
                <div class="field-group">
                    <div class="field-label">
            ...
            <div class="card" id="department-card">
                ...
                <div class="field-group">
                    ...
                    <div id="f_dept_code" class="field-value editable" data-field="deptCode"><?= $staff_data['dept'] ?? '' ?></div>
                </div>
                <div class="field-group">
                    <div class="field-label">
