...
<body>
    <div class="container">
        ...
        <div class="content-grid">
            ...
            <div class="card" id="personal-card">
                ...
                <div class="field-group">
                    ...
                    <div class="field-value editable" data-field="staffName">Dr. Rajesh Kumar Sharma</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-envelope"></i> Email Address
                    </div>
                    <div class="field-value editable" data-field="email">rajesh.sharma@university.edu</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-phone"></i> Mobile Number
                    </div>
                    <div class="field-value editable" data-field="mobile">+91 98765 43210</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-id-card"></i> Aadhar Number
                    </div>
                    <div class="field-value editable" data-field="aadhar">XXXX-XXXX-7890</div>
                </div>
            </div>
            ...
            <div class="card" id="department-card">
                ...
                <div class="field-group">
                    ...
                    <div class="field-value editable" data-field="deptName">Computer Science & Engineering</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-hashtag"></i> Department Code
                    </div>
                    <div class="field-value editable" data-field="deptCode">CSE-2024</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                    ...
                    <div class="field-value editable" data-field="role" data-type="select">
                        ...
                        <span class="display-value">Teaching</span>
                    </div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                    ...
                    <div class="field-value editable" data-field="duties">4</div>
                </div>
            </div>
            ...
            <div class="card" id="academic-card">
                ...
                <div class="field-group">
                    ...
                    <div class="status-container">
                        ...
                        <span class="status-label status-on-label" id="statusLabel">ON</span>
                    </div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                    ...
                    <div class="field-value editable" data-field="account">XXXXXX7890123456</div>
                </div>
                <div class="field-group">
                    <div class="field-label">
                        <i class="fas fa-code"></i> IFSC Code
                    </div>
                    <div class="field-value editable" data-field="ifsc">SBIN0001234</div>
                </div>
            </div>
        </div>
        ...
        <div class="actions">
            ...
            <div class="edit-actions" id="editActions" style="display: none;">
                <button class="edit-btn save" id="saveBtn">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const defaultCourses = ['EL235141', 'EL235142', 'EL235143', 'EL235144'];
